                           ...
                           <form method="POST" action="{{ route('register') }}">
                            @csrf
                              <div class="row">
                                 ...
                                 <div class="col-lg-6">
                                    <div class="form-group">
                                       <label for="cpassword_confirmation" class="form-label">Confirm Password</label>
                                       <input type="text" class="form-control" id="cpassword_confirmation"  name="password_confirmation" placeholder=" ">
                                    </div>
                                 </div>
